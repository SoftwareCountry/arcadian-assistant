namespace Arcadia.Assistant.Web.Models.Calendar
{
    ...
    public class SickLeavesConverter
    {
        ...
        {
            return new CalendarEventModel(CalendarEventTypes.Sickleave, this.ToDatesPeriod(sickLeave),
                sickLeave.Status.ToString());
        }
        ...
        public CalendarEventWithIdModel ToCalendarEventWithId(SickLeaveDescription sickLeave)
        {
            ...
            return new CalendarEventWithIdModel(dtoId, CalendarEventTypes.Sickleave, this.ToDatesPeriod(sickLeave),
                sickLeave.Status.ToString());
        }
