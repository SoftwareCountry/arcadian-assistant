namespace Arcadia.Assistant.ExternalStorages.SharepointOnline
{
    ...
    public abstract class SharePointContextProvider
    {
        ...
        ///     The redirect url to SharePoint if the status is ShouldRedirect. <c>Null</c> if the status is
        ///     Ok or CanNotRedirect.
        /// </param>
        ...
        public SharePointContext GetSharePointContext(HttpContextBase httpContext)
        {
            ...
            var spContext = this.LoadSharePointContext(httpContext);
