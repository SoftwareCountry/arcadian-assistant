namespace Arcadia.Assistant.ExternalStorages.Sharepoint
{
    ...
    public static class TokenHelper
    {
        ...
        /// <param name="appHostUrl">
        ///     Url authority of the hosted add-in.  If this is null, the value in the HostedAppHostName
    ...
    public class MultipleSymmetricKeySecurityToken : SecurityToken
    {
        ...
        /// <summary>
        ///     Returns a value that indicates whether the key identifier for this instance can be resolved to the specified key
        ///     identifier.
        /// </summary>
        /// <param name="keyIdentifierClause">A SecurityKeyIdentifierClause to compare to this instance</param>
        /// <returns>
        ///     true if keyIdentifierClause is a SecurityKeyIdentifierClause and it has the same unique identifier as the Id
        ...
        private readonly List<SecurityKey> securityKeys;
